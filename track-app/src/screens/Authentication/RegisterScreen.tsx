...
import Animated, { FlipInYLeft, FlipInYRight, FadeInRight } from 'react-native-reanimated'
                        ...
                        <View style={styles.mainContentContainer}>
                            ...
                            <View style={{ marginVertical: 30, rowGap: 20 }}>
                                <Animated.View entering={FlipInYRight}>
                                    <FloatingLabelInput label='Username' value={username} width={deviceSize.width * 0.5} height={50} titleActiveColor='rgb(251,91,9)' titleInactiveColor='white' handleTextChange={setUsername} />
                                </Animated.View>
                                <Animated.View entering={FlipInYRight.delay(400)}>
                                    <FloatingLabelInput label='Email' value={email} width={deviceSize.width * 0.5} height={50} titleActiveColor='rgb(251,91,9)' titleInactiveColor='white' handleTextChange={setEmail} />
                                </Animated.View>
                                <Animated.View entering={FlipInYLeft.delay(800)}>
                                    <FloatingLabelInput value={password} label='Password' width={deviceSize.width * 0.5} height={50} titleActiveColor='rgb(251,91,9)' titleInactiveColor='white' handleTextChange={setPassword} hidden={true} />
                                </Animated.View>
                            </View>

                            <AuthButton callback={handleRegister} text='REGISTER' style={styles.button} />

                            <AuthNavText navigationCallback={() => navigation.navigate('Login')} mainText='Already have an account?' highlightText='Login.' />
                        </View>
                    </Shadow>
                </ImageBackground>
            </View>
